...
import numpy as np
import torch
from models import SVHN_generator, USPS_generator, weights_init
from sklearn.manifold import TSNE
from tqdm import tqdm
from train_digits import get_dataloader
...
for idx in range(3):
    ...
    checkpoint_path = "snapshot/{}_{}_to_{}_k{}_mbsize{}_lr{}_epsilon{}_mass{}_tau{}/best_model.pth".format(
        args.method, args.source_ds, args.target_ds, args.k, args.mbsize, args.lr, args.epsilon, args.mass, args.tau
    )
